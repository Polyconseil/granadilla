...
urlpatterns = patterns('',
    ...
    url(r'^devices/(?P<device_fullname>[^/]+)/$', 'granadilla.views.device_attr'),
    url(r'^devices/(?P<device_fullname>[^/]+)/password/$', 'granadilla.views.device_password', name='device_password'),
    url(r'^devices/(?P<device_fullname>[^/]+)/delete/$', 'granadilla.views.device_delete'),
